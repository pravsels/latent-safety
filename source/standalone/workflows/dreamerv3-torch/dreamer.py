...
#        task, use_gpu=False, num_envs=1, use_fabric= False
        ...
        if hasattr(acts, "discrete"):
            ...
            random_actor = torchd.independent.Independent(
                torchd.uniform.Uniform(
                    0.25*torch.Tensor(-torch.ones_like(torch.tensor(acts.low))).repeat(env.num_envs, 1),
                    0.25*torch.Tensor(torch.ones_like(torch.tensor(acts.low))).repeat(env.num_envs, 1), #.repeat(config.envs, 1),
                ),
                1,
            )
    ...
    for i in range(40):
        epo = i*10
        policy.load_state_dict(torch.load('/home/kensuke/IsaacLab/test_wrist_20hz_2cam1env_newrew_128_200exp_fail_cont/lcrl/1009/004103/lcrl/dmc_walker_walk/wm_actor_activation_ReLU_critic_activation_ReLU_game_gd_steps_1_tau_0.005_training_num_1_buffer_size_40000_c_net_512_4_a1_512_4_a2_512_4_gamma_0.95/noise_0.1_actor_lr_0.0001_critic_lr_0.001_batch_1_step_per_epoch_40000_kwargs_{}_seed_0/epoch_id_'+str(epo)+'/policy.pth'))
